...
if __name__ == "__main__":
    ...
    clean_df = pd.read_csv(join(get_data_path(), PROCESSED_RECORDS_FILENAME), encoding="iso-8859-1")
    ...
    #put tdm into df
    #xd = pd.DataFrame(c, columns = vectorizer.get_feature_names())
    #xd.index = clean_df['iati.identifier'].tolist()
