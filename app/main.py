...
from constants import VECTORIZER_FILENAME, TERM_DOCUMENT_MATRIX_FILENAME, PROCESSED_RECORDS_FILENAME, INPUT_DATA_FILENAME
import pickle
...
def search():
    ...
    results = process_query(search_term, vectorizer, term_document_matrix, processed_iati_records, full_iati_records).to_html()
